...
var require_vue_paginate = __commonJS({
  "node_modules/vue-paginate/dist/vue-paginate.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : global.VuePaginate = factory();
    })(exports, function() {
      "use strict";
      var warn = function() {
      };
      ...
      var RIGHT_ARROW = "»";
      var ELLIPSES = "…";
      var LimitedLinksGenerator = function LimitedLinksGenerator2(listOfPages, currentPage, limit) {
      ...
      function getFullLinks(vm, h) {
        var allLinks = vm.showStepLinks ? [vm.stepLinks.prev].concat(vm.listOfPages, [vm.stepLinks.next]) : vm.listOfPages;
        return allLinks.map(function(link) {
          ...
          var linkText = link === vm.stepLinks.next || link === vm.stepLinks.prev ? link : link + 1;
      ...
      function getLimitedLinks(vm, h) {
        ...
        limitedLinks = vm.showStepLinks ? [vm.stepLinks.prev].concat(limitedLinks, [vm.stepLinks.next]) : limitedLinks;
      ...
      function addAdditionalClasses(linksContainer, classes) {
        Object.keys(classes).forEach(function(selector) {
          ...
          linksContainer.querySelectorAll(selector).forEach(function(node) {
            var selectorValue2 = classes[selector];
            if (Array.isArray(selectorValue2)) {
              selectorValue2.forEach(function(c) {
                return node.classList.add(c);
              });
            } else {
              node.classList.add(selectorValue2);
            }
          });
        });
      }
...
export default require_vue_paginate();
/*! Bundled license information:

vue-paginate/dist/vue-paginate.js:
  (**
   * vue-paginate v3.6.0
   ...
   *)
*/
//# sourceMappingURL=vue-paginate.js.map
